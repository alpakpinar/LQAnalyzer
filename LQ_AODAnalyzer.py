...
fout = ROOT.TFile("GENSIM_MET_1_4TeV_1_50METCut.root", "RECREATE")

LQMass = '1.4 TeV'
LQCoupling = 1

#Prepare the MET histogram
MET_hist=ROOT.TH1F('MET', 'Missing Transverse Energy, M = ' + LQMass + ' #lambda = ' + str(LQCoupling), 27, 50, 1400)
...
inputDir = '/eos/uscms/store/user/aakpinar/SLQ_MCProduction/shape_study/SLQ_1_4TeV_1/SLQ_1_4TeV_1_LHEGS/190521_155428/0000' #50 GeV MET cut
...
MET_hist.Draw("hist")
canv.Print('GENSIM_MET_1_4TeV_1_50METCut.png')

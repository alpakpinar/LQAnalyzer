...
V_19 = Vertex(name = 'V_19',
              particles = [ P.g, P.sdn__tilde__, P.sdn ],
              color = [ 'T(1,3,2)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_7})

V_20 = Vertex(name = 'V_20',
              particles = [ P.g, P.g, P.sdn__tilde__, P.sdn ],
              color = [ 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(1,0):C.GC_9,(0,0):C.GC_9})

V_21 = Vertex(name = 'V_21',
              particles = [ P.g, P.sun__tilde__, P.sun ],
              color = [ 'T(1,3,2)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_7})

V_22 = Vertex(name = 'V_22',
              particles = [ P.g, P.g, P.sun__tilde__, P.sun ],
              color = [ 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(1,0):C.GC_9,(0,0):C.GC_9})

V_23 = Vertex(name = 'V_23',
              particles = [ P.ve__tilde__, P.u, P.sun__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_41})

V_24 = Vertex(name = 'V_24',
              particles = [ P.u__tilde__, P.ve, P.sun ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS2 ],
